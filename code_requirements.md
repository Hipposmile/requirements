...
- Anführungszeichen: Für Strings müssen in Python standardmäßig doppelte Anführungszeichen, in JavaScript bei einzeiligen Strings doppelte Anführungszeichen und bei mehrzeiligen Backticks verwendet werden. In Dart müssen einfache Anführungszeichen verwendet werden. Wenn das standardmäßig verwendete Zeichen im String vorkommt, müssen bei JavaScript Backticks verwendet werden, bei Python und Dart das jeweils andere Zeichen, esseidenn, auch dieses existiert im String. Ist dies der Fall, muss das standardmäßige Zeichen verwendet und im String escapet werden.
